...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_2a.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 2 : Quiz</a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berikut adalah penjelasan dari blok selektor dan deklarasi CSS, kecuali?</h1>

	  	<!-- Quiz -->
	  	<form action="level_2c.php" method="post" id="quiz">
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" required>
            <label for="question-1-answers-A">A) Setiap deklarasi menyertakan nama properti CSS dan nilai, dipisahkan oleh titik koma.</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" required>
            <label for="question-1-answers-B">B) Blok deklarasi berisi satu atau lebih deklarasi yang dipisahkan oleh tanda titik koma.</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" required>
            <label for="question-1-answers-C">C) Beberapa deklarasi CSS dipisahkan dengan titik koma, dan blok deklarasi dikelilingi oleh kurung kurawal.</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" required>
            <label for="question-1-answers-D">D) Selektor menunjuk ke elemen HTML yang ingin Anda berikan gaya.</label>
            </div>
