...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_3b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Selektor CSS</h1>
		<p>Selektor CSS digunakan untuk <b>"menemukan"</b> (atau <b>memilih</b>) elemen HTML yang ingin diberikan gaya.</p>
		<p>Kita dapat membagi selektor CSS menjadi lima kategori:</p>
		<ul>
		<li><b>Simple selectors</b> (pilih elemen berdasarkan <b>name</b>, <b>id</b>, <b>class</b>)</li>
		<li><b>Combinator selectors</b> (pilih elemen berdasarkan <b>hubungan tertentu</b>)</li>
		<li><b>Pseudo-class selectors</b> (pilih elemen berdasarkan <b>kondisi tertentu</b>)</li>
		<li><b>Pseudo-elements selectors</b> (pilih dan gaya bagian dari elemen)</li>
		<li><b>Attribute selectors</b> (pilih elemen berdasarkan <b>atribut atau nilai atribut</b>)</li>
		</ul>
		<p>Halaman ini akan menjelaskan selektor CSS paling dasar.</p>
