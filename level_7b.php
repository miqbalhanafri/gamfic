...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_7a.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 7 : Quiz</a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berikut ini cara menggunakan properti warna background yang benar adalah?</h1>

	  	<!-- Quiz -->
	  	<form action="level_7c.php" method="post" id="quiz">
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp><h2 style="backgroundcolor:DodgerBlue;">Warna background</h2>
</xmp>
</div>
<!-- End Kode CSS --></label>
            </div>
