...
<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge w3-third">
		...
		<img src="uploadfoto/<?= $row["gambar"]; ?>" class="w3-round w3-hover-sepia" alt="<?= $row["username"]; ?>" width="50%" style="object-fit: cover;" height="100px"> 
		<?php endforeach; ?>
	  </div>
...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-panel w3-yellow w3-display-container">
	  ...
	  <li>Evaluasi target silakan diisi setelah anda melakukan pembelajaran selama 5 hari.</li>
	  </ol>
