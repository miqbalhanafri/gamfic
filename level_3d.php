...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_3b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 3 : CSS Selectors</a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_3e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>CSS Selektor Elemen</h1>

	  	<p>Memilih nama elemen HTML (nama tag, misal : p, h1, body) sebagai target style/gaya.</p>

		<h3>Contoh :</h3>

		<p>Di sini, semua elemen &lt;p&gt; pada halaman akan ke tengah, dengan warna teks merah:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3d_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

<hr>
		<h1>CSS Selektor id</h1>
		<ul>
		<li>Selektor id menggunakan atribut id dari elemen HTML untuk memilih elemen tertentu.</li>
		<li>Id suatu elemen adalah unik di dalam sebuah halaman, jadi selektor id digunakan untuk memilih satu elemen unik!</li>
		<li>Untuk memilih elemen dengan id tertentu, tulis karakter hash (#), diikuti oleh id elemen.</li>
		</ul>

		<h3>Contoh :</h3>

		<p>Style/gaya CSS di bawah ini akan diterapkan ke elemen HTML dengan id = "para1":</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3d_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <p><b>Catatan: Nama id tidak dapat dimulai dengan angka!</b></p>

<hr>

		<h1>CSS Selektor Class</h1>
		<ul>
		<li>Selektor class memilih elemen HTML dengan atribut class tertentu.</li>
		<li>Untuk memilih elemen dengan class tertentu, tulis karakter titik (.), diikuti dengan nama class.</li>
		</ul>

		<h3>Contoh :</h3>

		<p>Pada contoh ini semua elemen HTML dengan class = "center" akan berwarna merah dan ke tengah:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3d_coba3.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

<hr>

		<p>Anda juga dapat menentukan bahwa hanya elemen HTML spesifik yang akan dipengaruhi oleh class.</p>

	    <h3>Contoh :</h3>

	    <p>Dalam contoh ini hanya elemen &lt;p&gt; dengan class = "center" yang akan ke posisi tengah:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3d_coba4.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

<hr>

	    <p>Elemen HTML juga dapat merujuk ke lebih dari satu class.</p>

	    <h3>Contoh :</h3>

	    <p>Dalam contoh ini elemen &lt;p&gt; akan ditata sesuai dengan class = "center" dan ke class = "large":</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3d_coba5.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <p><b>Catatan: Nama class tidak dapat dimulai dengan angka!</b></p>
