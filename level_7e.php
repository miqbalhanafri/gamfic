...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_7d.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berikut ini cara menggunakan properti background gambar yang benar adalah?</h1>

	  	<!-- Quiz -->
	  	<form action="level_7f.php" method="post" id="quiz">
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>body {
  background-image: ("images/paper.jpg");
}
</xmp>
</div>
<!-- End Kode CSS --></label>
