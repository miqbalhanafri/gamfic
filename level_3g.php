...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_3e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_3h.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Selektor Universal CSS</h1>

	  	<p>Selektor universal (*) memilih semua elemen HTML pada halaman.</p>

		<h3>Contoh :</h3>

		<p>Aturan CSS di bawah ini akan memengaruhi setiap elemen HTML pada halaman:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3g_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

<hr>
		<h1>Grouping Selektor CSS</h1>
		<ul>
		<li>Grouping selektor memilih semua elemen HTML dengan definisi gaya yang sama.</li>
		<li>Lihatlah kode CSS berikut (elemen h1, h2, dan p memiliki definisi gaya yang sama):</li>
		</ul>
...
<!-- End Kode CSS -->
		...
		<p>Akan lebih baik untuk mengelompokkan selektor, untuk meminimalkan kode.</p>

		<p>Untuk membuat grup selektor, pisahkan setiap pemilih dengan koma.</p>

		<h3>Contoh :</h3>

		<p>Dalam contoh ini kami telah mengelompokkan selektor dari kode di atas:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_3g_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
