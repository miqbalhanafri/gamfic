...
<!-- Design by Muhammad Iqbal Hanafri -->
<meta charset="UTF-8">
...
<div class="w3-content w3-display-container" style="max-width:900px;">
  <div class="w3-container"> 
    <p class="w3-animate-top" style="text-align:center;font-size:80px;"><img src="images/gamfic logo.png" width="75%"><br>
    <a href="course.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge">Learn now</a>  
    </p>
