...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_7b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_7e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<p>Properti background-image menetapkan gambar yang akan digunakan sebagai latar belakang suatu elemen.</p>
		<p>Secara default, gambar diulang sehingga mencakup seluruh elemen.</p>

		<h3>Contoh :</h3>
		<p>Gambar latar belakang untuk halaman dapat diatur seperti ini:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_7d_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>


	  	<h3>Contoh :</h3>
		<p>Contoh ini menunjukkan kombinasi teks dan gambar latar yang buruk. Teksnya sulit dibaca:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_7d_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <p>Catatan : images/... adalah nama folder. Artinya gambar tersebut berada di dalam folder images dan berekstensi .jpg, .png, atau gif.</p>
