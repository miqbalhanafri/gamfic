...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_6d.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Untuk melengkapi kode CSS di bawah ini, yang benar adalah?</h1>

<!-- Kode CSS -->
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp><p ....................................>Warna background</p>
</xmp>
</div>
<!-- End Kode CSS -->

	  	<!-- Quiz -->
	  	<form action="level_6f.php" method="post" id="quiz">
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" required>
            <label for="question-1-answers-A">A) style="bgcolor:dodgerblue;"</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" required>
            <label for="question-1-answers-B">B) style="background-color;blue:"</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" required>
            <label for="question-1-answers-C">C) style="background-color:greenyellow;"</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" required>
            <label for="question-1-answers-D">D) style="backgroundcolor:red;"</label>
            </div>
