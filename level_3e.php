...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_3d.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 3 : Quiz</a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Bagaimana cara agar sebuah paragraf bisa mengambil style koding CSS dibawah ini? </h1>
...
<!-- End Kode CSS -->
	  	...
	  	<!-- Quiz -->
	  	<form action="level_3f.php" method="post" id="quiz">
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" required>
            <label for="question-1-answers-A">A) &lt;p id="center"&gt;Ini adalah sebuah paragraf.&lt;/p&gt;.</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" required>
            <label for="question-1-answers-B">B) &lt;p class="center"&gt;Ini adalah sebuah paragraf.&lt;/p&gt;.</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" required>
            <label for="question-1-answers-C">C) &lt;p para1="center"&gt;Ini adalah sebuah paragraf.&lt;/p&gt;.</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" required>
            <label for="question-1-answers-D">D) &lt;p class="center large"&gt;Ini adalah sebuah paragraf.&lt;/p&gt;.</label>
            </div>
