...
$tampilreview = query("SELECT COUNT(levels) AS jmlreview FROM updates
	WHERE user='$userid'
	");
...
<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge w3-third">
		...
		<img src="uploadfoto/<?= $row["gambar"]; ?>" class="w3-round w3-hover-sepia" alt="gamfic" width="100%" style="object-fit: cover;" height="200px">
		<?php endforeach; ?>
	  </div>
...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container w3-xxlarge w3-third"><h1><a href="#" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><?php foreach ( $tampilpoints as $row ) : ?><?= $row["pointstotal"]; ?><?php endforeach; ?> Points</a></h1></div>
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge w3-third"><h1><a href="#" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 
...
<?php endforeach; ?>
	  ...
	  <div class="w3-col w3-container w3-twothird"><p>Alhamdulillah, ini level sahabat ya. Terus belajar dan belajar ya, semangat menuju level tertinggi dan dapatkan points-nya. Chayoo...!!</p></div>
	</div>
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container w3-xxlarge w3-third"><h1><a href="#" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><?php foreach ( $tampilreview as $row ) : ?>

	<?= $row["jmlreview"]; ?>

<?php endforeach; ?> Reviews</a></h1></div>
	  <div class="w3-col w3-container w3-twothird"><p>Jumlah review / materi pelajaran yang di ulang sahabat. Semakin banyak kamu mereview, maka akan semakin faham kamu terhadap materi belajar...!! </p></div>
	</div>
