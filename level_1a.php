...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_1b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<ul>
			<li><b>CSS</b> adalah singkatan dari <b>C</b>ascading <b>S</b>tyle <b>S</b>heets</li>
			<li>CSS mendeskripsikan <b>bagaimana elemen HTML tampil di sebuah layar komputer, cetak, atau media lainnya.</b></li>
			<li>CSS <b>mempercepat kerja kita</b>. Dengan CSS kita mampu mengontrol desain banyak halaman web sekaligus.</li>
			<li>External stylesheets disimpan dalam bentuk <b>file CSS</b>.</li>
		</ul>
