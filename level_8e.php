...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_8d.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 8 : Quiz</a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berdasarkan kode CSS berikut ini, hasilnya adalah?</h1>

<div class="w3-white w3-padding notranslate">
<div style="border:5px dotted black;padding:8px;margin-top:8px;margin-bottom:16px;border-width: 25px 10px 4px 35px;">Ini adalah sebuah paragraf</div></div>

	  	<!-- Quiz -->
	  	<form action="level_8f.php" method="post" id="quiz">
...
<xmp>style="border:5px dotted black; padding:none; margin-top:8px; 
  margin-bottom:16px; border-width: 25px 10px 4px 35px;"
</xmp>
</div>
<!-- End Kode CSS --></label>
            </div>
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>style="border:5px solid black; padding:8px; margin-top:8px; 
  margin-bottom:16px; border-width: 10px 25px 4px 35px;"
</xmp>
</div>
<!-- End Kode CSS --></label>
            </div>
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>style="border:5px dotted black; padding:8px; margin-top:8px; 
  margin-bottom:16px; border-width: 25px 10px 4px 35px;"
</xmp>
</div>
<!-- End Kode CSS --></label>
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>style="border:5px dashed black; padding:8px; margin-top:8px; 
  margin-bottom:16px; border-width: 10px 25px 4px 35px;"
</xmp>
</div>
<!-- End Kode CSS --></label>
