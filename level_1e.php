...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_1d.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 1 : Introduction</a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_1f.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>CSS menyelesaikan Masalah Besar</h1>

		<ul>
			<li>HTML memiliki fungsi membuat kerangka umum sebuah website, dan tidak terlalu dipersiapkan untuk fokus kepada desain atau tampilan.</li>
			<li>Sebelumnya, HTML memiliki tag khusus untuk format warna dan sebagainya, seperti tag bgcolor, dsb. Akan tetapi, hal ini hanya bisa diterapkan pada satu halaman website. </li>
			<li>Ketika website kita memiliki banyak halaman, mungkin bisa puluhan atau bahkan ribuan, maka anda akan kesulitan merubah style atau gaya. Satu website saja yang anda rubah, maka anda memiliki tugas untuk merubah banyak website lainnya. </li>
			<li>Oleh karena itu, World Wide Consortium (W3C) membuat CSS, yang menggantikan format tradisional HTML.</li>
		</ul>
