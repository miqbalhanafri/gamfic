...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_7b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<p>Properti <b>background-color</b> menentukan warna latar belakang suatu elemen.</p>

		<h3>Contoh :</h3>
		<p>Warna latar belakang halaman diatur seperti ini:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_7a_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

		<p>Dengan CSS, warna bisa ditentukan oleh:</p>
		<ul>
			<li>Nama warna, seperti "red", "yellow", "greenyellow".</li>
		...
		<h1>Elemen lainnya</h1>
		<p>Anda dapat mengatur warna latar belakang untuk elemen HTML apa pun:</p>

		<h3>Contoh :</h3>
		<p>Di sini, elemen &lt;h1&gt;, &lt;p&gt;, and &lt;div&gt;  akan memiliki warna latar belakang yang berbeda:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_7a_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
