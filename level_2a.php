...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_2b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<ul>
			<li>Rangkaian aturan CSS terdiri dari <b>selektor</b> dan blok <b>deklarasi</b>:</li>
			<img src="images/selector.png" class="w3-round">
			<li>Selektor menunjuk ke elemen HTML yang ingin Anda berikan gaya.</li>
			<li>Blok deklarasi berisi satu atau lebih deklarasi yang dipisahkan oleh tanda titik koma.</li>
			<li>Setiap deklarasi menyertakan nama properti CSS dan nilai, dipisahkan oleh titik dua.</li>
			<li>Beberapa deklarasi CSS dipisahkan dengan titik koma, dan blok deklarasi dikelilingi oleh kurung kurawal.</li>
		</ul>
