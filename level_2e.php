...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_2d.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 2 : Evaluation</a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berdasarkan kode berikut ini, mana yang menunjukkan selektor?</h1>
...
p {
  ...
  text-align: center;
	  	...
	  	<!-- Quiz -->
	  	<form action="level_2f.php" method="post" id="quiz">
                    
            
            <br>
            <input type="text" name="question-1-answers" class="w3-input w3-round-xxlarge" id="question-1-answers-A" required>
            <p>Note : tuliskan dalam huruf kecil.</p>
