...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_8b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_8e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<p>Properti <code class="w3-codespan" class="w3-codespan">border-width</code> menentukan lebar empat sisi border.</p>
		<p>Lebar dapat ditetapkan sebagai ukuran tertentu (dalam px, pt, cm, em, dll) atau dengan menggunakan salah satu dari tiga nilai yang ditentukan sebelumnya: tipis (<b>thin</b>), sedang (<b>medium</b>), atau tebal (<b>thick</b>):</p>

		<h3>Contoh :</h3>
		<p>Contoh lebar border yang berbeda:</p>
...
<div style="border:thick dotted black;padding:8px;margin-top:8px;margin-bottom:8px">thick border-width</div>
      ...
      <div class="w3-panel">
	  <a href="level_8d_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

<hr>

		<h1>Specific Side Widths</h1>
		<p>Properti <code class="w3-codespan" class="w3-codespan">border-width</code> dapat memiliki dari satu hingga empat nilai (untuk border atas, border kanan, border bawah, dan border kiri):</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_8d_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
