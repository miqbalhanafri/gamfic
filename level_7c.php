...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahpoints($_POST) > 0 ) {
    echo "
      ...
      document.location.href = 'level_7d.php';
      </script>
    ";
  } else {
    echo "
      ...
      document.location.href = 'level_7b.php';
      </script>
    ";
  }
...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  ...
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 7 : Quiz Answer</a></h1></div>
...
<input type='hidden' name='levels' value='7'>
<input type='hidden' name='points' value='180'>
<input type='hidden' name='quiz' value='7A'>
<button class='w3-button w3-section w3-ripple w3-theme-d2 w3-round-xxlarge' type='submit' name='submit' style='width:50%'> next <i class='fas fa-chevron-circle-right w3-ripple'></i></button>
            	...
            	echo "<a href='level_7b.php' style='text-decoration:none;'><span style='color:#854078;'>try again <i class='fas fa-chevron-circle-left w3-ripple'></i></a></span>";
            }
