...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_4h.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level Up</a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="two.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
    ...
    <center>
      <h1><i class="fas fa-trophy w3-animate-fading" style="font-size:150px; color:#854078;"></i></h1><h1>Congratulations</h1><p><a href="two_reflect.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge">Refleksi per level <i class='fas fa-check-circle'></i></a></p></center>
