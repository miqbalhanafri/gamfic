...
function  tambahtarget($data) {
	// ambil data dari tiap elemen dalam form
	global $conn;

	$user = $_SESSION["userId"];
	$target_level = htmlspecialchars($data["target_level"]);
	$target_waktu = htmlspecialchars($data["target_waktu"]);
	$target_points = htmlspecialchars($data["target_points"]);
	$target_reviews = htmlspecialchars($data["target_reviews"]);
	
	// query insert data
	$query = "INSERT INTO target
				VALUES
			('', '$target_level', '$target_waktu', '$target_points', '$target_reviews', '$user')
			";
	mysqli_query($conn, $query);
...
function  tambahevaluate($data) {
	// ambil data dari tiap elemen dalam form
	global $conn;

	$user = $_SESSION["userId"];
	$evaluate_level = htmlspecialchars($data["evaluate_level"]);
	$evaluate_waktu = htmlspecialchars($data["evaluate_waktu"]);
	$evaluate_points = htmlspecialchars($data["evaluate_points"]);
	$evaluate_reviews = htmlspecialchars($data["evaluate_reviews"]);
	$evaluate_detail = htmlspecialchars($data["evaluate_detail"]);

	// query insert data
	$query = "INSERT INTO evaluate
				VALUES
			('', '$evaluate_level', '$evaluate_waktu', '$evaluate_points', '$evaluate_reviews', '$evaluate_detail', '$user')
			";
	mysqli_query($conn, $query);
...
function  tambahreflectgamfic($data) {
	// ambil data dari tiap elemen dalam form
	global $conn;

	$user = $_SESSION["userId"];
	$reflection = htmlspecialchars($data["reflection"]);
...
function hapusreflectgamfic($id) {
	global $conn;
	mysqli_query($conn, "DELETE FROM reflect WHERE id=$id");
...
// Menghubungkan dengan gamfic
function ubahreflectgamfic($data) {
	global $conn;
