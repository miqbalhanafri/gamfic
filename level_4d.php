...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_4b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_4e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<h1>Internal CSS</h1>
		<p>Internal CSS dapat digunakan jika satu halaman HTML memiliki gaya yang unik.</p>
		<p>Internal CSS didefinisikan di dalam elemen &lt;style&gt;, di dalam bagian head.</p>

		<h3>Contoh :</h3>
		<p>Internal CSS didefinisikan dalam elemen <b>&lt;style&gt;</b>, di dalam bagian <b>&lt;head&gt;</b> dari halaman HTML:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_4d_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <hr>

		<h1>Inline CSS</h1>
		<p>Inline CSS dapat digunakan untuk menerapkan gaya unik untuk elemen tunggal.</p>
		<p>Untuk menggunakan inline CSS, tambahkan atribut style ke elemen yang relevan. Atribut style dapat berisi properti CSS apa pun.</p>

		<h3>Contoh :</h3>
		<p>Inline CSS didefinisikan dalam atribut "style" elemen yang relevan:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_4d_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
