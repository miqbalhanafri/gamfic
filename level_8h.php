...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_8g.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berdasarkan kode berikut ini, maka border yang akan tampil adalah?</h1>
...
<!-- End Kode CSS -->
	  	...
	  	<!-- Quiz -->
	  	<form action="level_8i.php" method="post" id="quiz">
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" required>
            <label for="question-1-answers-A">A) Warna border red atas, green bawah, blue kanan dan yellow kiri</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" required>
            <label for="question-1-answers-B">B) Warna border red kiri, green atas, blue kanan dan yellow bawah</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" required>
            <label for="question-1-answers-C">C) Warna border red atas, green kanan, blue kiri dan yellow bawah</label>
            </div>
                    
            <div class="w3-panel w3-light-grey w3-border w3-round">
            <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" required>
            <label for="question-1-answers-D">D) Warna border red atas, green kanan, blue bawah dan yellow kiri</label>
            </div>
