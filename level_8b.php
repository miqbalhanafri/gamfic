...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_8a.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>Berikut ini cara menggunakan properti border garis putus-putus adalah?</h1>

	  	<!-- Quiz -->
	  	<form action="level_8c.php" method="post" id="quiz">
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>p.dashed {border-style: dashed;}
</xmp>
</div>
<!-- End Kode CSS --></label>
            </div>
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>p.solid {border-style: solid;}
</xmp>
</div>
<!-- End Kode CSS --></label>
            </div>
...
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>p.double {border-style: double;}
</xmp>
</div>
<!-- End Kode CSS --></label>
            </div>
