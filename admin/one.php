...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Edit user of Gamfic (SRL & Gamification)</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can edit the users of the Gamfic (SRL & Gamification)</p></div>
	</div>
