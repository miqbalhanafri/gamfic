...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_6e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_6h.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<p>Anda dapat mengatur warna teks:</p>

<h3 style="color:tomato">Hello World</h3>
<p style="color:dodgerblue">Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. </p>
<p style="color:mediumseagreen">Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. Ini adalah sebuah paragraf. </p>

		<h3>Contoh :</h3>

<!-- Kode CSS -->
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp><h1 style="color:Tomato;">Hello World</h1>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_6g_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <hr>

	  	<h1>CSS Border Color</h1>
		<p>Anda dapat mengatur warna border/batas:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_6g_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
