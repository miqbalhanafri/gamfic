...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_5e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 5 : CSS Comments</a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_5h.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>HTML and CSS Comments</h1>
		<p>Dari HTML yang telah anda pelajari, Anda mengetahui bahwa Anda dapat menambahkan komentar ke sumber HTML Anda dengan menggunakan sintaks <code class="w3-codespan">&lt;!--...--&gt;</code>.</p>
		<p>Dalam contoh berikut, kami menggunakan kombinasi komentar HTML dan CSS:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_5g_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
