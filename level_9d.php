...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_9b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 9 : CSS Margin</a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_9e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
		...
		<p>Untuk mempersingkat kode, dimungkinkan untuk menentukan semua properti margin dalam satu properti.</p>
		<p>Properti <code class="w3-codespan">margin</code> bisa digunakan untuk menyingkat properti margin individu:</p>
		...
		<p>Jadi, inilah cara kerjanya:</p>
		<p>Jika properti margin memiliki empat nilai:</p>
		<p><b>margin: 25px 50px 75px 100px;</b></p>

		<ul>
			<li>margin atas 25px</li>
			<li>margin kanan 50px</li>
			<li>margin bawah 75px</li>
			<li>margin kiri 100px</li>
		</ul>

		<h3>Contoh :</h3>
		<p>Gunakan properti margin shorthand dengan empat nilai:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_9d_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

<hr>

		<p>Jika properti <code class="w3-codespan">margin</code> memiliki tiga nilai:</p>
		<p><b>margin: 25px 50px 75px;</b></p>

		<ul>
			<li>margin atas 25px</li>
			<li>margin kanan dan kiri 50px</li>
			<li>margin bawah 75px</li>
		</ul>

		<h3>Contoh :</h3>
		<p>Gunakan properti margin shorthand dengan tiga nilai:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_9d_coba2.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <hr>

		<p>Jika properti <code class="w3-codespan">margin</code> memiliki dua nilai:</p>
		<p><b>margin: 25px 50px;</b></p>

		<ul>
			<li>margin atas bawah 25px</li>
			<li>margin kanan dan kiri 50px</li>
		</ul>

		<h3>Contoh :</h3>
		<p>Gunakan properti margin shorthand dengan dua nilai:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_9d_coba3.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>

	  <hr>

		<p>Jika properti <code class="w3-codespan">margin</code> memiliki satu nilai:</p>
		<p><b>margin: 25px;</b></p>

		<ul>
			<li>semua sisi margin adalah 25px</li>
		</ul>

		<h3>Contoh :</h3>
		<p>Gunakan properti margin shorthand dengan satu nilai:</p>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_9d_coba4.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
