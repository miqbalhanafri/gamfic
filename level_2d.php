...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_2b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-left'></i></a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s8"><h1><a class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%">Level 2 : CSS Syntax</a></h1></div>
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_2e.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_2d_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
		...
		<ul>
			<li>p adalah <b>selektor</b> dalam CSS (menunjukkan elemen HTML apa yang ingin Anda berikan style/gaya: &lt;p&gt;)</li>
			<li><b>color</b> adalah properti, dan <b>red</b> adalah nilai properti.</li>
			<li><b>text-align</b> adalah properti, dan <b>center</b> adalah nilai properti.</li>
		</ul>
