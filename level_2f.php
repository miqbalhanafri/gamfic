...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahpoints($_POST) > 0 ) {
    echo "
      ...
      document.location.href = 'level_2g.php';
      </script>
    ";
  } else {
    echo "
      ...
      document.location.href = 'level_2f.php';
      </script>
    ";
  }
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<center><h1><?php
            ...
            if (strtolower("$answer1") == "p") { $totalCorrect++; }
...
<input type='hidden' name='quiz' value='2B'>
<button class='w3-button w3-section w3-ripple w3-theme-d2 w3-round-xxlarge' type='submit' name='submit' style='width:50%'> next <i class='fas fa-chevron-circle-right w3-ripple'></i></button>
              ...
              ";
            	...
            	echo "<a href='level_2e.php' style='text-decoration:none;'><span style='color:#854078;'>try again <i class='fas fa-chevron-circle-left w3-ripple'></i></a></span>";
            }
