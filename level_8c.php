...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahpoints($_POST) > 0 ) {
    echo "
      ...
      document.location.href = 'level_8d.php';
      </script>
    ";
  } else {
    echo "
      ...
      document.location.href = 'level_8b.php';
      </script>
    ";
  }
...
<input type='hidden' name='points' value='210'>
<input type='hidden' name='quiz' value='8A'>
<button class='w3-button w3-section w3-ripple w3-theme-d2 w3-round-xxlarge' type='submit' name='submit' style='width:50%'> next <i class='fas fa-chevron-circle-right w3-ripple'></i></button>
            	...
            	echo "<a href='level_8b.php' style='text-decoration:none;'><span style='color:#854078;'>try again <i class='fas fa-chevron-circle-left w3-ripple'></i></a></span>";
            }
