...
<!-- End mendapatkan variabel pointsku -->
	...
	<div class="w3-row w3-theme-d1">
	  ...
	  <div class="w3-col w3-container w3-xxlarge s2"><h1><a href="level_5b.php" class="w3-button w3-section w3-theme-l1 w3-ripple w3-round-xxlarge" style="width:100%"><i class='fas fa-angle-right'></i></a></h1></div>
	</div>
	...
	<div class="w3-row w3-theme-l3">
	  <div class="w3-col w3-container">
	  	...
	  	<h1>CSS Comments</h1>
		<p>CSS Comments digunakan untuk menjelaskan kode, dan dapat membantu ketika Anda mengedit source code di kemudian hari.</p>
		<p>CSS Comments diabaikan / tidak ditampilkan oleh browser.</p>
		<p>CSS Comments ditempatkan di dalam elemen <code class="w3-codespan">&lt;style&gt;</code>, dan dimulai dengan <code class="w3-codespan">/*</code> dan diakhiri dengan <code class="w3-codespan">*/</code>:</p>

		<h3>Contoh :</h3>

<!-- Kode CSS -->
<div class="w3-panel w3-border w3-light-grey w3-round-large">
<xmp>/* Ini adalah komentar satu baris */
p {
  color: red;
}
</xmp>
...
<!-- End Kode CSS -->
      ...
      <div class="w3-panel">
	  <a href="level_5a_coba.php" class="w3-button w3-large w3-theme-d3 w3-round-xxlarge" target="_blank">Coba Koding <i class='fas fa-code'></i></a>
	  </div>
